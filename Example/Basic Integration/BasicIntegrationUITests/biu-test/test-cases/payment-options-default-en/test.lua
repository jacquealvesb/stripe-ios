...
biu.save_ref() -- check if apple play is preselected
...
biu.tap_button("Buy Now")
biu.tap_button("Pay from")
biu.save_ref() -- check if 3220 card is still selected

biu.tap_button("Apple Pay")
biu.tap_button("Products")
biu.tap_button("Buy Now")
biu.tap_button("Pay from")
biu.save_ref() -- check if Apple Pay is still selected
...
biu.tap_button("Pay from")
biu.wait_for("Apple Pay")
biu.save_ref() -- check if Apple Pay is selected